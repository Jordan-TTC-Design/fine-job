<template>
  <div class="container-fuild">
    <!-- 搜尋banner -->
    <div class="mainBanner bg-primary section">
    ...
    <!-- 熱門職位 -->
    <div ref="sectionHotJob" class="section container">
        ...
        <div class="col-lg-6 col-12 mb-lg-0 mb-4">
          ...
          >
            ...
            <div class="txtBox">
              ...
              <p class="jobTag" v-if="sortHotJobs[0].options.job.salaryInterView">薪資面議</p>
            </div>
          </div>
        </div>
                ...
                >
                  ...
                  <div class="txtBox">
                    ...
                    <router-link
                      ...
                      :to="
                        `/products-list/company/${sortHotJobs[index].options.company.companyLink}`
                      "
          ...
          <div class="col-md-5 col-12  weeklyCompany__Box--right">
            <div class="imageBox p-md-6 p-4 pb-4 bg-white">
              <swiper
                ...
                v-if="dataOk"
              >
                <swiper-slide v-for="companyImage in weeklyCompany.imagesUrl" :key="companyImage">
              ...
              <div class="companyContentBox mb-3 pe-md-8 ">
                <div class="d-flex mb-4">
                  <div class="logoImageBox me-4 ">
                    <img class="logoImage" :src="weeklyCompany.imageUrl" alt="" />
                  </div>
...
export default {
  ...
  computed: {
    weeklyCompany() {
      ...
      const weeklyCompany = temArray[0];
