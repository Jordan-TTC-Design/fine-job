        ...
        <div class="row justify-content-center">
          <div class="col-lg-8 col-12">
            <div class="newCompanyForm box--shadow" v-if="formStep === 1">
              <Form ref="sendFormInfoForm1" v-slot="{ errors }" @submit="changeStep('next')">
                ...
                <div class="row">
                  ...
                  <div class="col-12">
                    <div
                      class="form__inputBox form__infoEditBox border-bottom border-gray-line pb-4"
                    >
                      <div class="form__labelBox">
                  ...
                  <div class="col-12">
                    <h3 class="page__title--sub">
                      <span class="title__icon"></span>公司環境形象照片
                    </h3>
                    <p class="mb-4">
            ...
            <div class="newCompanyForm box--shadow" v-if="formStep === 3">
              <Form ref="sendFormInfoForm3" v-slot="{ errors }" @submit="processAddCompanyForm">
                ...
                <div class="row justify-content-center">
                  <div class="col-md-8 col-12">
                    ...
                    <p class="mb-4 text-center">
                      恭喜您已完成填寫創建公司帳戶流程，
                      本公司會於3個工作天內審核資料，如審核完畢會寄 email 給您！
                      預祝貴公司招募順利～
                    </p>
                    <p class="mb-4 text-center">
                      如有任何問題歡迎您寄信聯絡我們，很高興能為您服務～
                    </p>
  ...
  methods: {
    ...
    deleteImgInput(index) {
      if (index) {
        ...
        this.form.user.options.company.companyLogoUrl = '';
      }
    },
    // 以下是針對資料api動作
    // 取得購物車資料
